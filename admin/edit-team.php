...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['image']) && !empty($_FILES['image']['name'])) {
        ...
        if ($fileUploaded->status == "success") {
            ...
            update($pdo, "team", $_POST, "id", $_GET['id']);
...
$team = findById($pdo, "team", $_GET['id']);
...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <h5 class="card-header mb-0 pb-2 text-primary mb-3">Edit Team Member</h5>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input required type="text" name="name" value="<?php echo $team->name; ?>" class="form-control" id="basic-default-fullname" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-3">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3 w-100">
                                ...
                                <input required type="text" name="designation" value="<?php echo $team->designation; ?>" class="form-control" id="basic-default-fullname" />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3 w-100">
                                ...
                                <textarea required class="form-control" name="description" id="" width="100%" rows="10" value=""><?php echo $team->description; ?></textarea>
                            </div>
                        </div>
