...
if (isset($_GET['delete']) && !empty($_GET['delete'])) {
    delete($pdo, "thematic_areas", "id", $_GET['delete']);
...
if (isset($_POST['submit'])) {
    ...
    if ($fileUploaded->status == "success") {
        ...
        insert($pdo, "thematic_areas", $_POST);
...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <h5 class="card-header mb-0 pb-2 text-primary mb-3">Add Thematic Area</h5>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input required type="text" name="title" class="form-control" id="basic-default-fullname" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-3">
        ...
        <div class="card px-4 pb-4 mt-5">
            <div class="d-flex justify-content-between align-items-md-center align-items-start flex-md-row flex-column ">
                <h5 class="card-header px-0 pb-3">Thematic Area List</h5>
            </div>
                        ...
                        <?php if (!empty($areas)) : ?>
                            <?php foreach ($areas as $index => $area) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <img src="../assets/images/thematic/<?php echo $area->image; ?>" alt="" style="width: 40px; height: auto;">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="edit-area.php?id=<?php echo $area->id; ?>"><button type="button" class="edit-data">Edit</button></a>
                                            <a href="?delete=<?php echo $area->id; ?>"><button class="delete-data" type="button">Delete</button></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
